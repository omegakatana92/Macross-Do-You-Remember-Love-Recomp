...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "MacrossDoYouRememberLove",
    .project_root_env = "MACROSSDOYOUREMEMBERLOVERECOMP_PROJECT_ROOT",
    .build_dir_env = "MACROSSDOYOUREMEMBERLOVERECOMP_BUILD_DIR",
    .force_setup_env = "MACROSSDOYOUREMEMBERLOVERECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLPS_020.05_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "MacrossDoYouRememberLove_Recompiled",
    .prepare_note =
